...
plot_takeoff(formblockLand,'landing')
#%%
...
with open('HookedOnAFeeling_block_land.json', 'w') as f:
    json.dump(data, f)

tgen.plot_trajectories(trajectories)
tgen.animate_trajectories('hooked_block_land.mp4', trajectories, 1)
...
tgen.gazebo_animate_trajectories("HookedOnAFeeling_block_land.world",trajectories)
