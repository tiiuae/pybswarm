...
with open('scripts/data/semicircle_block_land.json', 'w') as f:
    json.dump(data, f)

tgen.gazebo_animate_trajectories("semicircle_block_land.world",trajectories)

tgen.plot_trajectories(trajectories)
plt.show()

tgen.animate_trajectories('semicircle_block_land.mp4', trajectories, fps=5)
