...
with open('scripts/data/testing12form.json', 'w') as f:
     json.dump(data, f)

tgen.plot_trajectories(trajectories)
plt.show()

tgen.gazebo_animate_trajectories("testing_12.world",trajectories)
...
tgen.animate_trajectories('testing_12.mp4', trajectories, fps=5)
